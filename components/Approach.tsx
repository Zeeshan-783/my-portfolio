  ...
  return (
    <section className="w-full py-20  " id="approach">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        description="We'll collabrate to map out your website's goals,
        target audience, and key functionalities. We'll discuss things like site structure ,
        ...
        description="Once we agree on the plan, I cue mt lofi playlist 
        and dive into coding. From initial sketches to polished code, I 
        ...
        Based on the approve design, I'll translate everthing into functional code, 
